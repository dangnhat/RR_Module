...
override PKGDIR = xconfig_usbserialdevice
...
package/%.xdc.inc package/%_xconfig_usbserialdevice.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_usbserialdevice" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e430X .dlls: usbserialdevice.pe430X

-include package/cfg/usbserialdevice_pe430X.mak
-include package/cfg/usbserialdevice_pe430X.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/usbserialdevice_pe430X.dep
endif
usbserialdevice.pe430X: package/cfg/usbserialdevice_pe430X.xdl
	@


ifeq (,$(wildcard .libraries,e430X))
usbserialdevice.pe430X package/cfg/usbserialdevice_pe430X.c: .libraries,e430X
endif

package/cfg/usbserialdevice_pe430X.c package/cfg/usbserialdevice_pe430X.h package/cfg/usbserialdevice_pe430X.xdl: override _PROG_NAME := usbserialdevice.xe430X
package/cfg/usbserialdevice_pe430X.c: package/cfg/usbserialdevice_pe430X.cfg
package/cfg/usbserialdevice_pe430X.xdc.inc: package/cfg/usbserialdevice_pe430X.xdl
package/cfg/usbserialdevice_pe430X.xdl package/cfg/usbserialdevice_pe430X.c: .interfaces

clean:: clean,e430X
	-$(RM) package/cfg/usbserialdevice_pe430X.cfg
	-$(RM) package/cfg/usbserialdevice_pe430X.dep
	-$(RM) package/cfg/usbserialdevice_pe430X.c
	-$(RM) package/cfg/usbserialdevice_pe430X.xdc.inc

clean,e430X::
	-$(RM) usbserialdevice.pe430X
.executables,e430X .executables: usbserialdevice.xe430X

usbserialdevice.xe430X: |usbserialdevice.pe430X

-include package/cfg/usbserialdevice.xe430X.mak
usbserialdevice.xe430X: package/cfg/usbserialdevice_pe430X.oe430X 
	$(RM) $@
	@$(MSG) lnke430X $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/cl430 -q -u _c_int00 -z  -o $@ package/cfg/usbserialdevice_pe430X.oe430X   package/cfg/usbserialdevice_pe430X.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.msp430.elf.MSP430X.rootDir)/lib/libc.a
	
usbserialdevice.xe430X: export C_DIR=
usbserialdevice.xe430X: PATH:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)
usbserialdevice.xe430X: Path:=$(ti.targets.msp430.elf.MSP430X.rootDir)/bin/;$(PATH)

usbserialdevice.test test,e430X test: usbserialdevice.xe430X.test

usbserialdevice.xe430X.test:: usbserialdevice.xe430X
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 usbserialdevice.xe430X.test
else
	@$(MSG) running $<  ...
	$(call EXEC.usbserialdevice.xe430X, ) 
endif

clean,e430X::
	-$(RM) $(wildcard .tmp,usbserialdevice.xe430X,*)


clean:: clean,e430X

clean,e430X::
	-$(RM) usbserialdevice.xe430X
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
usbserialdevice_pe430X.oe430X,copy : package/cfg/usbserialdevice_pe430X.oe430X
usbserialdevice_pe430X.se430X,copy : package/cfg/usbserialdevice_pe430X.se430X

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_usbserialdevice
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_usbserialdevice.tar.dep
endif
package/rel/xconfig_usbserialdevice/xconfig_usbserialdevice/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_usbserialdevice/xconfig_usbserialdevice/package/package.rel.xml: package/build.cfg
package/rel/xconfig_usbserialdevice/xconfig_usbserialdevice/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_usbserialdevice/xconfig_usbserialdevice/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_usbserialdevice.tar: package/rel/xconfig_usbserialdevice.xdc.inc package/rel/xconfig_usbserialdevice/xconfig_usbserialdevice/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_usbserialdevice.xdc.inc,package/rel/xconfig_usbserialdevice.tar.dep)


release release,xconfig_usbserialdevice: all xconfig_usbserialdevice.tar
clean:: .clean
	-$(RM) xconfig_usbserialdevice.tar
	-$(RM) package/rel/xconfig_usbserialdevice.xdc.inc
	-$(RM) package/rel/xconfig_usbserialdevice.tar.dep
